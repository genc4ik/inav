...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8,  CH2N, PB14, TIM_USE_ANY        ,   1, 0), // S7           s11 
    DEF_TIM(TIM2,   CH1, PA15, TIM_USE_OUTPUT_AUTO,   1, 0), // S8           s9
    DEF_TIM(TIM2,   CH3, PB10, TIM_USE_OUTPUT_AUTO,   0, 0), // S9           s7
    DEF_TIM(TIM2,   CH4, PB11, TIM_USE_OUTPUT_AUTO,   1, 0), // S10          s8
    DEF_TIM(TIM12,  CH2, PB15, TIM_USE_OUTPUT_AUTO,   1, 0), // S11          s12
